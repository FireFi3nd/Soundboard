...
def on_button_click(row, col): #This is how the X's and O'c are placed
...
def check_winner(): # Determines how to win a game
...
def announce_winner(player): # shows whos the winner
    messagebox.showinfo("Game Over", "It's a draw!" if player == "Draw" else f"Player {player} wins!")
    reset_game()

def reset_game(): # this resets the game after it is won/lost/drawn
